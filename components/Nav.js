...
const Nav = () => {
  ...
  return(
    ...
    gap-y-10 px-4 md:px-40 xl:px-0 h-[80px] xl:h-max py-8 bg-white/70
    backdrop-blur-sm text-4xl xl:text-xl xl:rounded-full '>
        ...
        return (
          ...
          >
            ...
            <div className='absolute pr-14 right-0 hidden xl:group-hover:flex'>
               <div className='bg-white relative flex text-primary itemscenter p-[6px] rounded-[6px]'>
              ...
              <div className='border-solid border-l-white border-l-8 
                    border-y-transparent border-y-[8px] border-r-0 absolute -right-2'         ></div>
              </div>
            </div>
